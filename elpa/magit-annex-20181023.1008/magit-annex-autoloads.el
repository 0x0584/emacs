...

;;;### (autoloads nil "magit-annex" "magit-annex.el" (23505 42141
;;;;;;	709852 995000))
;;; Generated autoloads from magit-annex.el

(eval-after-load 'magit '(progn (require 'magit-popup) (when (boundp 'magit-dispatch-popup) (define-key magit-mode-map "@" 'magit-annex-popup-or-init) (magit-define-popup-action 'magit-dispatch-popup 64 "Annex" 'magit-annex-popup-or-init 33))))
