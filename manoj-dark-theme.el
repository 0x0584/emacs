...
(custom-theme-set-faces
 ...
 '(info-title-1 ((t (:bold t :weight bold :height 1.728))))
 '(info-title-2 ((t (:bold t :weight bold :height 1.44))))
 '(info-title-3 ((t (:bold t :weight bold :height 1.2))))
 ...
 '(change-log-conditionals ((t (:foreground "Aquamarine"))))
 '(change-log-date ((t (:italic t :slant oblique :foreground "BurlyWood"))))
 '(change-log-email ((t (:foreground "Aquamarine"))))
 '(change-log-file ((t (:bold t :weight bold :foreground "LightSkyBlue" :height 0.9))))
 '(change-log-function ((t (:foreground "Aquamarine"))))
 '(change-log-list ((t (:foreground "LightSkyBlue"))))
 '(change-log-name ((t (:bold t :weight bold :foreground "Gold"))))
